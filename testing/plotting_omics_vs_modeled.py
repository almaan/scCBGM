...
vae = clab.models.VAE.load_from_checkpoint("/data/bucket/ismaia11/conceptlab/models/vae-v2.ckpt")
vae.to(device)
vae.eval() 
...
vae = clab.models.CB_VAE.load_from_checkpoint("/data/bucket/ismaia11/conceptlab/models/vae_cbm-v2.ckpt")
vae.to(device)
vae.eval() 
