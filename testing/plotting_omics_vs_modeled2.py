...
dataset = clab.datagen.omics.OmicsDataGenerator.generate_from_dataset(n_obs = num_samples, dataset = dataset) 
...
vae = clab.models.VAE.load_from_checkpoint("/data/bucket/ismaia11/conceptlab/models/vae-v3.ckpt")
vae.to(device)
vae.eval() 
...
vae = clab.models.CB_VAE.load_from_checkpoint("/data/bucket/ismaia11/conceptlab/models/vae_cbm-v3.ckpt")
vae.to(device)
vae.eval() 
