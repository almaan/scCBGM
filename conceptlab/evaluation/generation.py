...
def reconstruction_loss(gt,pred,raw_data=None,plot=True):
	...
	if raw_data is not None:
		...
		for noise_level in noise_levels:
			...
			mse_noise = np.mean((gt - noisy_gex) ** 2)
		...
		if plot:
			...
			fig.add_trace(go.Scatter(x=noise_levels, y=mse_noise_array, mode="lines+markers", name="Noise MSE"))
