...
class CB_VAE_FM(BaseCBVAE):
    def __init__(
        ...
        **kwargs,
        ...
        cb_concepts_layers.extend(
            [nn.Linear(self.latent_dim, self.n_concepts), nn.Sigmoid()]
        )
    ...
    def loss_function(
        self, x, concepts, h, mu, logvar, pred_concept, unknown, **kwargs
    ):
        loss_dict = {}
    ...
    def train_loop(
        self, data, concepts, num_epochs, batch_size, lr=3e-4, lr_gamma=0.997
    ):
