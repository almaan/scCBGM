...
class CEM_VAE(pl.LightningModule):
    def __init__(self,config):
        ...
        for c in range(self.n_concepts):
            ...
            self.concept_context_generators.append(
                torch.nn.Sequential(*[
                    torch.nn.Linear(self.latent_dim,
    ...
    def forward(self, x,concepts=None):
        ...
        return {'x_pred':x_pred, 'z':z, 'mu':mu, 'logvar':logvar , 'pred_concept':pred_concept,'known_concepts':known_concepts, 'unknown':unknown}
    ...
    def loss_function(self, x,concepts, x_pred, mu, logvar,pred_concept,known_concepts,unknown ,**kwargs):
        loss_dict ={}
